...
# Your legal name
first_name = "Ayub"                 # Your first name in quotes Eg: "First", "Sai"
middle_name = "Oketch"            # Your name in quotes Eg: "Middle", "Vignesh", ""
last_name = "Odhiambo"                # Your last name in quotes Eg: "Last", "Golla"

# Phone number (required), make sure it's valid.
phone_number = "0791315022"        # Enter your 10 digit number in quotes Eg: "9876543210"

# What is your current city?
current_city = "Nairobi"                  # Los Angeles, San Francisco, etc.
'''
...
ethnicity = "Black or African American"              # "Decline", "Hispanic/Latino", "American Indian or Alaska Native", "Asian", "Black or African American", "Native Hawaiian or Other Pacific Islander", "White", "Other"
