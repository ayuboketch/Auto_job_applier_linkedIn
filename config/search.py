...
search_terms = ["Frontend Developer", "React Developer", "Javascript Developer", "Front End Developer", "Web Developer", "junior frontend Developer"]

# Search location, this will be filled in "City, state, or zip code" search box. If left empty as "", tool will not fill it.
search_location = "EMEA"           # Some valid examples: "", "United States", "India", "Chicago, Illinois, United States", "90001, Los Angeles, California, United States", "Bengaluru, Karnataka, India", etc.
